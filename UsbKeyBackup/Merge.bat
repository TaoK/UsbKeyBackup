"..\..\..\BuildTools\ILRepack\ILRepack.exe" /t:winexe /out:%1NewUsbKeyBackup.exe %1UsbKeyBackup.exe %1EasyProgressDialog.dll %1es\UsbKeyBackup.resources.dll
IF %ERRORLEVEL% NEQ 0 GOTO END

del %1EasyProgressDialog.dll
del %1EasyProgressDialog.pdb
del %1EasyProgressDialog.xml
